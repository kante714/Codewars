...
//PARAMETERS: an array of integers -> size is at least 3, always positive, may have duplicate numbers // a number (value) -> will always be number

//RETURNS: return how many number of time times you have to add up the smallest numbers in the array until their Sum becomes greater or equal to K (a number)
...
//PSEUDOCODE:
// Create a function that take in 2 arguments an array of integers and a number (value)
// declare variable 'numbersSorted' and set it to an ascending sorted version on an provided array
// declare variable 'total' and set it to 0
// loop over 'numbersSorted' and add each number to 'total'
// return index (i) if 'total' >= provided value
